    ...
    def register(self):
        ...
        if (new_username!="" and new_password!="" and confirm_password!=""):
            if new_password != confirm_password:
                ...
                self.customer_repo.create_user(self.first_name, self.last_name, self.gender, self.birthdate, self.phone_number,self.street_number, self.apart_number_input, self.postal_code, new_username, new_password)
